  ...
  <div class="header-seperation"> 
    <ul class="nav pull-left notifcation-center" id="main-menu-toggle-wrapper" style="display:none">  
     <li class="dropdown"> <a id="main-menu-toggle" href="#main-menu"  class="" > <div class="iconset top-menu-toggle-white"></div> </a> </li>     
      ...
      <!-- BEGIN LOGO -->
      <a href="<?php echo base_url(); ?>dashpeje"><img src="<?php echo base_url(); ?>assets/images/logo.png" class="logo" alt=""  data-src="<?php echo base_url(); ?>assets/images/logo.png" width="106" height="21"/></a>
      <!-- END LOGO --> 
      <ul class="nav pull-right notifcation-center">  
        <li class="dropdown" id="header_task_bar"> <a href="<?php echo base_url(); ?>dashpeje" class="dropdown-toggle active" data-toggle=""> <div class="iconset top-home"></div> </a> </li>
...
<div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url();?>dashpeje/updatepassword" method="POST" name="uppass" id="uppass">

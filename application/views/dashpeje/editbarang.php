                        ...
                        <form action="<?php echo base_url();?>dashpeje/editbarang/<?php echo $ca->IDBARANG?>" method="POST" name="editticket" id="editticket">
                          ...
                          <div class="col-md-8">
                              ...
                              <input id="harga" type="text" value ="<?php echo $ca->HARGABARANG;?>"  class="form-control col-md-6" placeholder="Harga Barang dalam Rupiah" name="hargabarang">
                          </div>
                                ...
                                <?php
                                    foreach ($lokasi as $loks){
                                      if( $loks->IDLOKASI == $ca->IDLOKASI){ 
                                        ?>
                                          <option selected="selected" value="<?php echo $loks->IDLOKASI?>"><?php echo $loks->NAMALOKASI?></option>
                                        <?php
                                      }
                                      else{
                                        ?>
                                          <option value="<?php echo $loks->IDLOKASI?>"><?php echo $loks->NAMALOKASI?></option>
                                        <?php
